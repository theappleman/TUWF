...
This module is used to generate HTTP responses, it is automatically loaded by
...
A C<Content-Encoding> header may be set by C<resBuffer()>. C<Set-Cookie>
headers set by C<reqCookie()> are not manipulated through this function.
